...
public class Student {
	//필드(데이터 집합)
	public static int count = 0; // 총 학생의 수
	...
	// 매게변수 값과 객체의 데이터가 동일하다면 true, 아니면 false를 반환
	// 자료형 boolean형을 써서 트루인지 거짓인지 판단
	// equals라는 객체에 name,age, gender 매개변수 선언 
	public boolean equals(String name, int age, String gender){
		// 객체안의 name과 매개변수 name과 같거나 객체안의 age와 매개변수 age가 같고 객체안에 gender와 매개변수
		// gender가 같다면 true로 리턴
